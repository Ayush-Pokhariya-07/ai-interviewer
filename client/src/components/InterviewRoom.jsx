...
const InterviewRoom = ({
    ...
    const buildGreeting = () => {
        ...
        if (jobRole) {
            ...
            greeting += `I've reviewed your resume and I'm excited to discuss your skills in ${resumeData.technicalSkills
                ?.slice(0, 3)
                .join(", ")}${resumeData.technicalSkills?.length > 3 ? ", and more" : ""
                }. `;
        }
    ...
    useEffect(() => {
        ...
        if (duration !== undefined && duration !== null) {
            ...
            // Handle string duration (legacy format: "Short (15 min)" or just "15")
        ...
        <div className="flex flex-col h-[calc(100vh-4rem)] max-w-4xl mx-auto p-4 gap-6">
            ...
            <div className="bg-gray-800/50 rounded-2xl p-6 backdrop-blur-sm border border-gray-700">
                <div className="flex items-center justify-between">
                    ...
                    {timeRemaining !== null && (
                        <div
                            className={`flex items-center gap-2 px-4 py-2 rounded-xl font-mono text-lg font-bold border ${timeRemaining < 120
                ...
                <div className="flex items-center gap-6">
                    ...
                    >
                        <div className="w-12 h-12 rounded-full bg-purple-500/20 flex items-center justify-center border border-purple-500/30">
                            <Volume2
                                className={`w-6 h-6 text-purple-400 ${isPlaying ? "animate-pulse" : ""
                                    }`}
                            />
                        </div>
                    </div>
            ...
            `}
                    >
                        ...
                        {isRecording ? (
                            ...
                            <Mic
                                className={`w-10 h-10 ${isProcessing
                                    ? "text-gray-400"
                                    : "text-blue-500"
                                    }`}
                            />
