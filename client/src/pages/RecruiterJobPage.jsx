                ...
                {!jobId ? (
                    <>
                        ...
                        <form onSubmit={handleSubmit} className="bg-gray-800/50 rounded-2xl p-8 border border-gray-700 space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-semibold mb-2 text-gray-300">
                                    Interview Duration (minutes) <span className="text-red-400">*</span>
                                </label>
                                ...
                                <p className="text-xs text-gray-500 mt-1">Set any duration between 1 and 120 minutes</p>
                            </div>
                        ...
                        <div className="bg-gradient-to-br from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-8 space-y-6">
                            ...
                            <div className="grid md:grid-cols-3 gap-4 pt-4 border-t border-gray-700">
                                ...
                                <div>
                                    ...
                                    <div className="font-semibold">{formData.duration} minutes</div>
                                </div>
                            </div>
