 ...
 * Save interview result (called after interview completion)
 */
router.post("/save-result", saveInterviewMiddleware);

/**
 * GET /api/interview/recruiter-interviews
 * ?recruiterId=xxx&jobId=optional
 */
router.get("/recruiter-interviews", getRecruiterInterviewsMiddleware);

/**
 * GET /api/interview/:interviewId/details
 */
router.get("/:interviewId/details", getInterviewDetailsMiddleware);

/**
 * GET /api/interview/recruiter-stats
 * ?recruiterId=xxx
 */
router.get("/recruiter-stats", getRecruiterStatsMiddleware);
